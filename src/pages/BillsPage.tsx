import { useBills, useUploadBill } from "@/hooks/useApi";
  ...
  return (
    <div className="space-y-6 animate-fade-up">
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {bills.map((bill) => (
            <Card key={bill.id} className="border-border/50 overflow-hidden group">
              ...
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  <AvatarCircle 
                    name={bill.payerProfile.name}
                    imageUrl={bill.payerProfile.avatarUrl}
                    size="sm"
                  />
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium truncate">
                      {bill.payerProfile.name}
                    </p>
